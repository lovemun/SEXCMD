...
usage_message <- "USAGE: Rscript SEXCMD.R SEX_Marker.fasta total_read_counts Seq_type[1/2/3] input.fastq.gz
    Sequencing Type 1:Whole Exome Seq, 2:RNA-Seq, 3:Whole Genome Seq"
...
input_fastq <- as.character(args[3])
